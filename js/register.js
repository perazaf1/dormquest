...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function toggleRoleFields() {
        ...
        if (selectedRole === 'etudiant') {
            ...
            document.getElementById('ville_recherche').setAttribute('required', 'required');
            ...
            document.getElementById('type_loueur').setAttribute('required', 'required');
            document.getElementById('telephone').setAttribute('required', 'required');
        }
        
        // Animation d'apparition
        const visibleSection = selectedRole === 'etudiant' ? etudiantFields : loueurFields;
            ...
            if (file) {
                ...
                reader.onload = function(event) {
                    ...
                    if (!preview) {
                        ...
                        preview.innerHTML = '<img style="max-width: 150px; border-radius: 8px; border: 2px solid var(--color-primary);">';
